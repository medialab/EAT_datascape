...
//			}
			...
			$inBox.empty();
			$inBox.append($("<div style='width:" + (Math.floor(95 / numCols))+ "%; float: " + options.columnFloat + ";'></div>")); //"
			$col = $inBox.children(":last");
			$col.append( $('<div/>',{ 'class':"column-inner"}).append( $cache.clone() ) );
			...
			for(var loopCount=0;loopCount<maxLoops;loopCount++){
				...
				for (var i = 0; i < numCols; i++) {
					...
					$inBox.append($("<div class='" + className + "' style='width:" + (Math.floor(95 / numCols))+ "%; float: " + options.columnFloat + ";'></div>")); //"
				}
